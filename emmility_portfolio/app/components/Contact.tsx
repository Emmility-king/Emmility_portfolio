      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-center gap-4 mb-6">
          <div className="flex items-center gap-2">
            ...
            <a href="mailto:olafisoyeemmanuel7@gmail.com" className="text-sky-400 hover:underline">
        ...
        >
          <div className="mb-4 relative">
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 border border-sky-500 text-black py-2 px-6 rounded-2xl hover:bg-sky-500 hover:text-black transition-colors"
          >
